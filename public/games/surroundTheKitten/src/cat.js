!function (t) {
    ...
    var k = function (t) {
        ...
        return r(e, t), Object.defineProperty(e.prototype, "blocks", {
            ...
            get: function () {
                ...
                switch (t) {
                    case i.PLAYING:
                        break;
                    case i.LOSE:
                        this.setStatusText(f.default("猫跑到了地图边缘，你就输了"));
                        break;
                    case i.WIN:
                        this.setStatusText(f.default("猫无处可去，你赢了"));
                        break;
                    default:
                        return
                }
            ...
            if (this.cat.anims.isPlaying && this.cat.anims.stop(), this.state !== i.PLAYING) return this.setStatusText(f.default("游戏结束，重新开始")), this.reset(), !1;
            var n = this.getBlock(t, e);
            return n ? n.isWall ? (this.setStatusText(f.default("点击位置已经是墙，禁止点击")), !1) : this.cat.i === t && this.cat.j === e ? (this.setStatusText(
                f.default("点击的位置是猫的当前位置，禁止点击")), !1) : (n.isWall = !0, this.cat.isCaught() ? (this.setStatusText(f.default("猫无处可去，你赢了")), this.state = i.WIN, !1) : (this.setStatusText(f.default("你点击了") + "(" + t + ", " + e + ")"), this.cat.step() || (this.setStatusText(f.default("Cat admit defeat, you win!")), this.state = i.WIN), !0)) : (this.setStatusText(f.default("错误，当前位置不存在")), !1)
        }, e.prototype.reset = function () {
            this.cat.reset(), this.resetBlocks(), this.randomWall(), this.state = i.PLAYING, this.setStatusText(f.default("单击围绕小猫的点"))
    ...
    var i = n(0), s = function (t) {
        function e(e) {
            var n = this;
            e.credit || (e.credit = ""), e.backgroundColor || (e.backgroundColor = 15658734);
 ...
 */
    ...
    function l() {
        a.call(this), this.readyState = l.UNSENT, this.requestHeaders = {},
            this.requestBody = null, this.status = 0, this.statusText = "", this.upload = new a
    }
    ...
    var d = {
        ...
        _readyStateChange: function (t) {
            ...
            "function" == typeof this.onreadystatechange && this.onreadystatechange(new o("readystatechange")),
                this.dispatchEvent(new o("readystatechange")), this.readyState == l.DONE && this.dispatchEvent(new o("load", !1, !1, this)), this.readyState != l.UNSENT && this.readyState != l.DONE || this.dispatchEvent(new o("loadend", !1, !1, this))
        },
